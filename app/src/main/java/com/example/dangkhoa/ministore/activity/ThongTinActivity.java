...
public class ThongTinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng my_home = new LatLng(10.850627, 106.791254);
        mMap.addMarker(new MarkerOptions().position(my_home).title("miniStore").snippet("D5/1A4 - Đường 385 - Quận 9 - TP. Hồ Chí Minh").icon(BitmapDescriptorFactory.defaultMarker()));
        //mMap.setMapStyle(GoogleMap.MAP_TYPE_NORMAL);
        CameraPosition cameraPosition = new CameraPosition.Builder().target(my_home).zoom(90).build();
